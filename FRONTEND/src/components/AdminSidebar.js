...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { title: "Product Management", path: "/admin/products", icon: "📦" },
    { title: "Order Management", path: "/admin/orders", icon: "📋" },
    { title: "Payment Management", path: "/admin/payments", icon: "💳" },
    { title: "Employee Management", path: "/admin/employees", icon: "👨‍💼" },
    { title: "Supplier Management", path: "/admin/suppliers", icon: "🏭" },
    { title: "Inventory Management", path: "/admin/inventory", icon: "📦" },
    { title: "Feedback Management", path: "/admin/feedback", icon: "💬" }
  ];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {sidebarOpen && (
          <div style={{ fontSize: "20px", fontWeight: "bold" }}>Green Lion</div>
        )}
      </div>
